...
const buttonVariants = cva(
    "inline-flex shrink-0 items-center justify-center gap-2 rounded-md " +
        "text-sm font-medium whitespace-nowrap transition-all duration-300 outline-none " +
        "focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 " +
        "disabled:pointer-events-none disabled:opacity-35 aria-invalid:border-destructive " +
        ...
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
    {
        variants: {
            variant: {
                ...
                ghost: "text-foreground/90 hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50",
